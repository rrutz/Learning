...
Title::Title(bool topSolid, bool allSolid, sf::Color color, int title_width, int title_height, int xPos, int yPos)
	:
	topSolid(topSolid), 
	allSolid(allSolid),
	...
	pixel_Width(pixel_Width)
{
	...
	// create bricks
	world.push_back(Title(true, true, sf::Color::Red, 100.0f, 200.0f, 100.0f, pixel_Height - groundHeight - 80.f));
	...
	world.push_back(Title(true, true, sf::Color::Red, 10.0f, pixel_Height, 0.0f, 0.0f));
	world.push_back(Title(true, true, sf::Color::Red, 10.0f, pixel_Height, pixel_Width -10.0f, 0.0f));
